  ...
  const Navbar: React.FC<NavbarProps> = ({ onDrawerChange }) => {
    ...
    return (
     <View className="relative bg-white">
      ...
      >
        <View
          className={`flex-row shadow-sm border border-neutral-200 rounded-full z-999 items-center justify-between py-1.5 px-3 ${
        ...
        {drawerOpen && (
          <View className="absolute z-99999 top-0 left-0 w-screen h-screen z-[1000]">
            <Pressable
